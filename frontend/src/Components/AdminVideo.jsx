                ...
                {problems.length === 0 ? (
                  ...
                  problems.map((problem, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 align-top mx-2 text-center">
                        <div className="flex items-center justify-center gap-3">
                          <button
                            onClick={() => handleFileSelect(problem._id)}
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white text-sm shadow cursor-pointer"
                          >
                            {/* Video Upload Icon */}
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-rose-500 hover:bg-rose-600 text-white text-sm shadow cursor-pointer"
                          >
                            {/* trash icon */}
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
