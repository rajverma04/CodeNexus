  ...
  return (
    ...
    <div className="min-h-screen bg-slate-900 p-8 relative">
      ...
      {submitting && (
        ...
        >
          <div className="flex flex-col items-center gap-4 bg-slate-800/90 p-6 rounded-lg shadow-lg">
            ...
            <div className="text-slate-100 text-sm">Creating problem... please wait</div>
          </div>
        </div>
      )}
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <h1 className="text-3xl font-bold text-slate-100">Create New Problem</h1>
...
//           <NavLink to="/delete">Update</NavLink>
//         </div>
//       </nav>
